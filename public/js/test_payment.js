...
$(document).ready(function () {
    ...
    payhere.onCompleted = function onCompleted(orderId) {
        ...
        $.ajax({
            url: "http://localhost/healthwave/patient/add_test_reservation/",
            type: "POST",
            data: {
            ...
            success: function (data) {
                ...
                window.location.href = '/healthwave/patient/payment_success?type=Test';
            },
                error: function (jqXHR, textStatus, errorThrown) {
