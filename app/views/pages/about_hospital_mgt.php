...
<html lang="en">
    ...
    <body>
        ...
        <img src="<?php echo URLROOT;?>/img/Timeline-pana.png" alt="">
            <div class="services-data-text">
                <h1>Manage hospital schedules</h1>
        ...
        <section class="services-data ">
            ...
            <img src="<?php echo URLROOT;?>/img/data.png" alt="">
        </section>
        </div>
        ...
        <div class="s1">
        <section class="services-data">
        <img src="<?php echo URLROOT;?>/img/Mobile payments.png" alt="">
            <div class="services-data-text">
