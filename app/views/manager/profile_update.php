...
<head>
   ...
   <title>Manager Profile Update</title>
</head>
<body>
    <div class="container-signup" style="height: 720px;" >

        
        <header>Manager Profile Update</header>

        <form action="<?php echo URLROOT; ?>/manager/profile_update" method="POST" style="height: 600px;">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" placeholder="Enter your mobile number" name="cnum" value="<?php echo $data['Contact_No'] ?>" required>
                        </div>
                        <div class="input-field">
                            <label></label>
